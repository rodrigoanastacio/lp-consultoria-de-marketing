    ...
    <>
      ...
      <TextImage>
        <div className={styles.wrapper}>
          ...
          <div>
            <h2>Só para você ter uma ideia, muitas pessoas que tem um perfil de negócios no Instagram, ainda estão perdidas na questão das estratégias, e muitas relatam os seguintes desafios:</h2>
            <ul>
              <li>Não consigo gerar engajamento com meus seguidores;</li>
              <li>Tenho vários seguidores, mas pouco clientes;</li>
              <li>Não consigo criar conteúdo atrativo para o meu perfil crescer;</li>
              <li>Não consigo me relacionar com meu público, por vergonha de aparecer em vídeos ou stories;</li>
              <li>Faço posts diariamente, mas sinto que falta algo para que meu conteúdo seja melhor;</li>
              <li>Tenho dificuldades em entender todas as estratégias de marketing digital;</li>
            </ul>
            <p>Eu poderia listar outros motivos, mas coloquei aqui, os principais pontos que muitas pessoas ainda encontram dificuldades. Tenho certeza que você pode passar por alguma situação parecida, que além de prejudicar o seu crescimento, te deixa muitas vezes com aquela sensação de desânimo, e de pensar “Será que isso realmente vai dar certo”? E muitas vezes isso te deixa sem um direcionamento para encontrar uma solução.</p>
          </div>
        </div>
      </TextImage>
